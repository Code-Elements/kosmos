$(function() {
	...
	$('.images_upload_preview').filedrop({
		...
		uploadFinished: function(i, file, response, time) {
			...
			var desc_ru = $('<div class="form_language-group image-group"><span class="form_title">RU</span><textarea class="image_description_input ru_img" name="images[description][ru][]" placeholder="Описание" /></div>');
			var desc_en = $('<div class="form_language-group image-group additional"><span class="form_title">EN</span><textarea class="image_description_input en_img" name="images[description][en][]" disabled="disabled" placeholder="Description"/></div>');
			var desc_fr = $('<div class="form_language-group image-group additional"><span class="form_title">FR</span><textarea class="image_description_input en_img" name="images[description][fr][]" disabled="disabled" placeholder="Description"/></div>');
			var desc_de = $('<div class="form_language-group image-group additional"><span class="form_title">DE</span><textarea class="image_description_input en_img" name="images[description][de][]" disabled="disabled" placeholder="Description"/></div>');
			var image_form = $('<input />', {'class': 'image_form', 'type': 'hidden', 'name': 'images[path][]', 'value': response});
			$('.images_upload_preview').append(image.append(image_delete, image_size.append(size_label, size_form), image_gallery.append(gallery_label, gallery_form), image_main.append(main_label, main_form), image_form, image_description.append(desc_ru, desc_en, desc_fr, desc_de)));
		},
